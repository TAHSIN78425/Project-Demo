...
import { useUser } from '../context/UserContext'; // Using the context hook
...
export default function Login() {
    ...
    const { setLoggedIn, setName: setContextName } = useUser(); // Destructure setLoggedIn and setName from context
    ...
    const handleSubmit = async (e) => {
        ...
        if (res.ok) {
            setName('');
            setPassword('');
            setLoggedIn(true); // Set the user as logged in in context
            setContextName(name); // Update the user's name in the context
